test_that("removing marker levels works", {
  ...
  expect_identical(
    remove_markers(cmbn = cmbn,
                   markers = c("IFNg"),
                   levels = c("~1~", "~2~")),
    c("IL2~1~TNF~1~IL17~2~", "IL2~1~TNF~2~IL17~1~", "IL2~1~TNF~2~IL17~2~",
  ...
  expect_identical(
    remove_markers(cmbn = cmbn,
                   ...
                   levels = levels),
    c("-2349d=-TNF-IL17+", "-2349d=-TNF+IL17-", "-2349d=-TNF+IL17+",
